   ...
   class otp
{
 ...
 public class projectmytest1 extends JFrame implements ActionListener{  
    JLabel l ,timeLabel;  
    JCheckBox cb1,cb2,cb3;  
    JButton b;  
     
   
    public projectmytest1(){
        timeLabel = new JLabel( new Date().toString() );
        timeLabel.setBounds(10,10,300,20);
...
{  
    ...
    {  
        ...
        if (userValue.equals("rohit") && passValue.equals(b)||(userValue.equals("chinmay") && passValue.equals(b))||(userValue.equals("sidram") && passValue.equals(b))) {  //if authentic, navigate user to a new page  
